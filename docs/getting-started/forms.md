...
description: Gather user input from a flow
---
...
- through [the URL](../api/process.html#browser-link);
...
With the usage of a [script](./scripting.html), the fields can be set dynamically at
